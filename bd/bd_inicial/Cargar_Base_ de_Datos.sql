...
-----------------------------------
-- CARGA DATOS A LAS TABLAS MAESTRO
-----------------------------------
...
copy t08_tipo_proyecto (pk_tipo_rubro,nb_tipo_rubro, tx_descripcion)  from 'C:\wamp\www\siscamp_1.7\bd\bd_inicial\tipo_proyecto.txt' DELIMITERS ';' ;


-- Coloca las secuencia de las tabla clase y categoria en el ultimo valor
ALTER SEQUENCE t05s_pk_clase RESTART WITH 59;
ALTER SEQUENCE t21s_pk_categoria RESTART WITH 10;
ALTER SEQUENCE t13s_pk_articulo RESTART WITH 236;
ALTER SEQUENCE gas_pk_raza RESTART WITH 61;
ALTER SEQUENCE t03s_pk_proveedor RESTART WITH 49;
ALTER SEQUENCE t08s_pk_tipo_proyecto RESTART WITH 9;


-------------------------------------
-- CREA PROYECTO NOMINA OBLIGATORIO
-------------------------------------
INSERT INTO t02_proyecto(tx_nombre, fe_inicial, fe_final, tx_descripcion, fk_responsable, fk_tipo_rubro, in_proy_activo,  tx_categoria_proyecto)
    VALUES ('NOMINA', '01-01-2000', '01-01-2040', 'AGRUPA TODOS LOS GASTOS POR NOMINA', 1, 1,'S', 'GASTO');
