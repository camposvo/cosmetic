...
---------------------------------------------------------------------------------------------------------------------------------------------------------*/	
	...
	$ls_sql = "SELECT nb_categoria, SUM(nu_cantidad * nu_precio) AS Precio_Total
		...
		WHERE EXTRACT(YEAR FROM t20_factura.fe_fecha_factura) = '2017' AND t20_factura.tx_tipo = 'GASTO' OR t20_factura.tx_tipo = 'NOMINA'
...
---------------------------------------------------------------------------------------------------------------------------------------------------------*/	
	...
	//print_r ($serie2_bar); // Imprime un arreglo por pantalla
					...
					<div class="widget-box transparent ">
						...
						<div class="widget-body">
							<div class="widget-main ">
								...
								<div class="col-sm-6">
									<div id="container_4" style="height: 400px; min-width: 310px"></div>
								</div>	
								
								<div class="col-sm-6">
									<div id="container_5" style="height: 400px; min-width: 310px"></div>
								</div>								
							</div><!-- /.widget-main -->
						</div><!-- /.widget-body -->						
					</div><!-- /.widget-box -->
