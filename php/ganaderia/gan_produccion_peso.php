...
-------------------------------------------------------------------------------------------*/
	if ($tarea == "E"){
		$ls_sql = "DELETE FROM gan_peso
						WHERE pk_peso = $pk_peso;";		
...
------------------------------------------------------------------------------------------------------------------------*/
	if ($tarea == "U"){
		...
		$ls_sql = "INSERT INTO gan_peso( fe_fecha_peso, fk_animal, tx_comentario, nu_peso ) 
			VALUES ( '$o_fecha', '$pk_animal','$x_observacion', '$o_peso')";
...
-------------------------------------------------------------------------------------------*/			
	$ls_sql = " SELECT fe_fecha_peso, nu_peso, tx_comentario, pk_peso FROM gan_peso 	
	...
	<div class="container-fluid">		
		...
		<div class="row">	
			...
			<div class="col-xs-12 col-sm-8 ">
				<div class="form-group">
					...
					<div class="col-sm-4" >	
						<div class="input-group">
							<input name="o_fecha" value="<?php echo $o_fecha;?>" class=" form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd/mm/yyyy" readonly />
				...
				<div class="form-group">
					<label  class="col-sm-3 control-label no-padding-right"  >Peso</label>
					<div class="col-sm-7" >
						<input class="col-xs-10 col-sm-7" name="o_peso" value="<?php echo $o_peso;?>" type="text"  placeholder="Peso" onKeyPress="return validardec(event)">
					</div>
				</div>
		...
		<div class="row">
				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover ">
					...
					<tbody>	
						<?php   										
							...
							fun_dibujar_tabla($obj_miconexion,$li_numcampo,$li_indicecampo, 'LISTAR_ANIMAL_PESO'); // Dibuja la Tabla de Datos
			...
			<input type="hidden" name="pk_peso" value="<?php echo $pk_peso;?>">
...
<script language="javascript" type="text/javascript">
	...
	function Asignar(){
		if (confirm('Desea Asignar el Peso?') == true){
	...
	function Eliminar_Animal_Peso(identificador){
		if (confirm('Desea Eliminar el Peso?') == true){
			document.formulario.tarea.value = "E";
			document.formulario.pk_peso.value = identificador;
			document.formulario.action = "gan_produccion_peso.php";
			document.formulario.method = "POST";
			document.formulario.submit();
		}
