...
---------------------------------------------------------------------------------------------*/
	$arr_tipo_parto  = Combo_Tipo_Parto();
...
-------------------------------------------------------------------------------------------*/
	if ($tarea == "E"){
		$ls_sql = "DELETE FROM gan_partos
						WHERE pk_partos = $pk_parto;";		
...
------------------------------------------------------------------------------------------------------------------------*/
	if ($tarea == "I"){
		...
		$ls_sql = "INSERT INTO gan_partos(   fe_fecha_registro, nu_machos, nu_hembras, nu_muertos, in_tipo, fk_ganado)
    VALUES ( '$o_fecha', $x_macho, $x_hembra, $x_muerto, '$o_tipo_parto', $pk_animal);";
...
-------------------------------------------------------------------------------------------*/				
	$ls_sql = "SELECT to_char(fe_fecha_registro, 'yyyy/mm/dd'), nu_machos, nu_hembras, nu_muertos, in_tipo, pk_partos
			  FROM gan_partos
	...
	<div class="container-fluid">		
		...
		<div class="row">	
			...
			<div class="col-xs-12 col-sm-8 ">					
				...
				<div class="form-group">
					<label  class="col-sm-3 control-label no-padding-right"  > Machos </label>
					<div class="col-sm-7" >
						<input class="col-xs-10 col-sm-7" name="x_macho" value="<?php echo $x_macho;?>" type="text"  placeholder="Machos" onKeyPress="return validardec(event)">
					</div>
				</div>
				
				<div class="form-group">
					<label  class="col-sm-3 control-label no-padding-right"  > Hembras </label>
					<div class="col-sm-7" >
						<input class="col-xs-10 col-sm-7" name="x_hembra" value="<?php echo $x_hembra;?>" type="text"  placeholder="Hembras" onKeyPress="return validardec(event)">
					</div>
				</div>
				
				<div class="form-group">
					<label  class="col-sm-3 control-label no-padding-right"  > Muertos  </label>
					<div class="col-sm-7" >
						<input class="col-xs-10 col-sm-7" name="x_muerto" value="<?php echo $x_muerto;?>" type="text"  placeholder="Muertos" onKeyPress="return validardec(event)">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-7" >	
						<select name="o_tipo_parto" class="col-xs-10 col-sm-7 chosen-select " data-placeholder="Selecciona un Cliente...">
							<?php
								if ($o_tipo_parto == ""){
								...
								foreach($arr_tipo_parto as $k => $v) {
									$ls_cadenasel =($k == $o_tipo_parto)?'selected':'';
				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover ">
					...
					<tbody>	
						<?php   										
							...
							fun_dibujar_tabla($obj_miconexion,$li_numcampo,$li_indicecampo, 'LISTAR_PARTO'); // Dibuja la Tabla de Datos
...
<script language="javascript" type="text/javascript">
	...
	function Asignar(){
		if (confirm('Esta seguro de Crear el Parto?') == true){
