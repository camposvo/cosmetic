...
function fun_dibujar_tabla($rs, $li_columnas, $li_indice, $operacion, $variable)
{
	...
	while ($row = pg_fetch_row($rs->li_idconsult)) {
		...
		if (strtoupper($operacion) == 'LISTAR_VENTA') {
			...
			echo "<td class='hidden'>" . $total . "</td>";     				// ESTA COLUMNA NO SE MUESTRA NUCA
			echo "<td class=''>" .  number_format($total, 2, ",", ".") . "</td>";

			echo "<td class='hidden'>" . $abono . "</td>";  					 // ESTA COLUMNA NO SE MUESTRA NUNCA 
			echo "<td class='hidden-480'>" . number_format($abono, 2, ",", ".") . "</td>";

			echo "<td class='hidden'>" . $debe . "</td>";                    // ESTA COLUMNA NO SE MUESTRA NUNCA 
		...
		if (strtoupper($operacion) == 'LISTAR_GASTO') {
			...
			echo "<td class='hidden-480'>" . $id. "</td>";
			echo "<td class=''>" . $fecha . "</td>";
			echo "<td class=''>" . $proveedor . "</td>";
			echo "<td class=''>" . $status . "</td>"; //Pedido					
			echo "<td class='hidden-480'>" . $ref . "</td>";

			echo "<td class='hidden'>" . $total . "</td>";
			echo "<td>" . number_format($total, 2, ",", ".") . "</td>";

			echo "<td class='hidden'>" . $abono . "</td>";
			echo "<td>" . number_format($abono, 2, ",", ".") . "</td>";


			echo "<td class='hidden'>" . $debe . "</td>";
			echo "<td>" . number_format($debe, 2, ",", ".") . "</td>";
