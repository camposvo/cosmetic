...
-------------------------------------------------------------------------------------------*/
	if ($tarea == "M") {
		$ls_sql = "SELECT pk_factura, fk_responsable, fk_cliente, to_char(fe_fecha_factura, 'dd/mm/yyyy'),  tx_nota,
					tx_concepto,  nu_total, nu_abono, fk_proyecto, in_pedido
					FROM t20_factura
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<select type="select-one" name="o_cliente" class="col-xs-10 col-sm-7 chosen-select " data-placeholder="Seleccionar">
													<?php
													if ($o_cliente == "") {
