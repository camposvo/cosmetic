						...
						<div class="col-xs-12 col-sm-6 widget-container-col">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="id-date-picker-1">Fecha Fact.</label>
								<div class="col-sm-4">
									<div class="input-group">
										<input name="o_fecha" value="<?php echo $o_fecha; ?>"
											class="col-xs-10 col-sm-6 form-control date-picker"
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<select type="select-one" name="o_cliente"
										class="col-xs-10 col-sm-7 chosen-select "
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input class="col-xs-10 col-sm-7" name="x_descuento"
										...
										onkeypress="return validardec(event)" onblur="calcular()"
