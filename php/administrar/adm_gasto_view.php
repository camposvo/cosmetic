											...
											<table id="" class="table table-striped table-bordered ">
												...
												<tbody>
													<tr>
														...
														<td>
															<input id='x_egreso_real' class="input-sm form-control" name="x_egreso_real" type="text" readonly />
														</td>
														<td>
			...
			$(document).ready(function() {
				...
				$('#dynamic-table').dataTable({
					...
					"fnFooterCallback": function(row, data, start, end, display) {
						...
						FiltroTotal = api.column(5, {
							search: 'applied'
						}).data().reduce(function(a, b) {
							return parseFloat(a) + parseFloat(b);
						}, 0);

						FiltroEgresoReal = api.column(7, {
							search: 'applied'
						}).data().reduce(function(a, b) {
							return parseFloat(a) + parseFloat(b);
						}, 0);

						FiltroCantidad = api.column(9, {
							search: 'applied'
						}).data().reduce(function(a, b) {
							return parseFloat(a) + parseFloat(b);
						}, 0);
						...
						FiltroEgresoReal = formato_numero(FiltroEgresoReal, 2, ',', '.');



						$('#x_sum_total').val(FiltroTotal);
						$('#x_sum_cantidad').val(FiltroCantidad);
						$('#x_egreso_real').val(FiltroEgresoReal);
